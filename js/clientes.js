    ...
    clientes.forEach(cliente => {
      ...
      tr.innerHTML = `
        ...
        <td class="px-6 py-4 text-right">
          <button onclick="editarCliente(${cliente.id},'${cliente.nombre}','${cliente.telefono || ''}','${cliente.placa}','${cliente.tipo_vehiculo}')" 
...
// =============================
window.editarCliente = function(id, nombre, telefono, placa, tipo) {
  document.getElementById("editId").value = id;
  document.getElementById("editNombre").value = nombre;
  document.getElementById("editTelefono").value = telefono;
  document.getElementById("editPlaca").value = placa;
  document.getElementById("editVehiculo").value = tipo;
